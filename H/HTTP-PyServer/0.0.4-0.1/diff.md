# Comparing `tmp/HTTP-PyServer-0.0.4.tar.gz` & `tmp/HTTP-PyServer-0.1.tar.gz`
...
### Comparing `HTTP-PyServer-0.0.4/src/server/render.py` & `HTTP-PyServer-0.1/src/server/render.py`
