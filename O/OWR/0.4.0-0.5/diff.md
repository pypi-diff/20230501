# Comparing `tmp/OWR-0.4.0.tar.gz` & `tmp/OWR-0.5.tar.gz`
...
## Comparing `OWR-0.4.0.tar` & `OWR-0.5.tar`
...
### Comparing `OWR-0.4.0/LICENSE` & `OWR-0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `OWR-0.4.0/owr/__init__.py` & `OWR-0.5/OWR/__init__.py`

 * *Files identical despite different names*

### Comparing `OWR-0.4.0/setup.py` & `OWR-0.5/setup.py`
