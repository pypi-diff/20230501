# Comparing `tmp/automatize-1.0b1.tar.gz` & `tmp/automatize-1.0b2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "automatize-1.0b1.tar", last modified: Wed Apr 27 10:41:50 2022, max compression
+gzip compressed data, was "automatize-1.0b2.tar", last modified: Mon May  1 01:08:00 2023, max compression
```

## Comparing `automatize-1.0b1.tar` & `automatize-1.0b2.tar`

### file list

```diff
@@ -1,13 +1,214 @@
-drwxr-xr-x   0 tarlisportela   (501) staff       (20)        0 2022-04-27 10:41:50.826660 automatize-1.0b1/
--rw-r--r--   0 tarlisportela   (501) staff       (20)    35721 2022-04-12 17:20:02.000000 automatize-1.0b1/LICENSE
--rw-r--r--   0 tarlisportela   (501) staff       (20)     2909 2022-04-27 10:41:50.826537 automatize-1.0b1/PKG-INFO
--rw-r--r--   0 tarlisportela   (501) staff       (20)     1021 2022-04-27 10:38:10.000000 automatize-1.0b1/README.md
-drwxr-xr-x   0 tarlisportela   (501) staff       (20)        0 2022-04-27 10:41:50.826359 automatize-1.0b1/automatize.egg-info/
--rw-r--r--   0 tarlisportela   (501) staff       (20)     2909 2022-04-27 10:41:50.000000 automatize-1.0b1/automatize.egg-info/PKG-INFO
--rw-r--r--   0 tarlisportela   (501) staff       (20)      210 2022-04-27 10:41:50.000000 automatize-1.0b1/automatize.egg-info/SOURCES.txt
--rw-r--r--   0 tarlisportela   (501) staff       (20)        1 2022-04-27 10:41:50.000000 automatize-1.0b1/automatize.egg-info/dependency_links.txt
--rw-r--r--   0 tarlisportela   (501) staff       (20)      401 2022-04-27 10:41:50.000000 automatize-1.0b1/automatize.egg-info/requires.txt
--rw-r--r--   0 tarlisportela   (501) staff       (20)        1 2022-04-27 10:41:50.000000 automatize-1.0b1/automatize.egg-info/top_level.txt
--rw-r--r--   0 tarlisportela   (501) staff       (20)     2452 2022-04-27 10:41:45.000000 automatize-1.0b1/pyproject.toml
--rw-r--r--   0 tarlisportela   (501) staff       (20)       38 2022-04-27 10:41:50.826699 automatize-1.0b1/setup.cfg
--rwxrwxrwx   0 tarlisportela   (501) staff       (20)     2444 2022-04-27 10:41:42.000000 automatize-1.0b1/setup.py
...
### Comparing `automatize-1.0b1/LICENSE` & `automatize-1.0b2/LICENSE`

 * *Files identical despite different names*

### Comparing `automatize-1.0b1/pyproject.toml` & `automatize-1.0b2/automatize/pyproject.toml`
...
-documentation = "https://github.com/ttportela/automatize"
...
### Comparing `automatize-1.0b1/setup.py` & `automatize-1.0b2/automatize/setup.py`
