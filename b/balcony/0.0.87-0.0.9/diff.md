# Comparing `tmp/balcony-0.0.87.tar.gz` & `tmp/balcony-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "balcony-0.0.87.tar", max compression
+gzip compressed data, was "balcony-0.0.9.tar", max compression
```

## Comparing `balcony-0.0.87.tar` & `balcony-0.0.9.tar`

### file list

```diff
@@ -1,33 +1,29 @@
--rw-r--r--   0        0        0    35149 2022-09-26 12:31:10.748997 balcony-0.0.87/LICENSE
--rw-r--r--   0        0        0     1864 2023-04-30 21:43:56.473616 balcony-0.0.87/README.md
--rw-r--r--   0        0        0      933 2023-04-29 21:23:00.565222 balcony-0.0.87/balcony/__init__.py
--rw-r--r--   0        0        0       52 2023-04-09 17:39:37.780212 balcony-0.0.87/balcony/__main__.py
--rw-r--r--   0        0        0     5622 2023-04-21 19:12:44.411429 balcony-0.0.87/balcony/aws.py
--rw-r--r--   0        0        0    11892 2023-04-21 17:50:16.401554 balcony-0.0.87/balcony/botocore_utils.py
--rw-r--r--   0        0        0    14211 2023-04-30 23:05:10.654585 balcony-0.0.87/balcony/cli.py
--rw-r--r--   0        0        0     2978 2023-04-30 21:07:33.646010 balcony-0.0.87/balcony/config.py
--rw-r--r--   0        0        0      488 2023-04-29 22:03:44.770391 balcony-0.0.87/balcony/custom_nodes/__init__.py
--rw-r--r--   0        0        0      540 2023-04-09 17:41:34.066674 balcony-0.0.87/balcony/custom_nodes/codebuild.py
--rw-r--r--   0        0        0     4856 2023-04-07 12:10:50.547169 balcony-0.0.87/balcony/custom_nodes/ecs.py
--rw-r--r--   0        0        0     7305 2023-04-09 17:41:50.509945 balcony-0.0.87/balcony/custom_nodes/iam.py
--rw-r--r--   0        0        0      728 2023-04-07 12:11:06.485573 balcony-0.0.87/balcony/custom_nodes/lambda_functions.py
--rw-r--r--   0        0        0     1086 2023-04-09 17:41:59.998051 balcony-0.0.87/balcony/custom_nodes/s3.py
--rw-r--r--   0        0        0      632 2023-04-09 17:42:05.685496 balcony-0.0.87/balcony/custom_nodes/ses.py
--rw-r--r--   0        0        0     1320 2023-04-09 17:42:11.817275 balcony-0.0.87/balcony/custom_nodes/ssm.py
--rw-r--r--   0        0        0     3149 2023-04-15 19:49:24.900287 balcony-0.0.87/balcony/custom_yamls/_example_service.yaml
--rw-r--r--   0        0        0      517 2023-04-06 12:50:36.974851 balcony-0.0.87/balcony/custom_yamls/ec2.yaml
--rw-r--r--   0        0        0        0 2023-04-05 13:32:52.449913 balcony-0.0.87/balcony/custom_yamls/ecs.yaml
--rw-r--r--   0        0        0     1501 2023-04-15 17:54:11.807061 balcony-0.0.87/balcony/custom_yamls/iam.yaml
--rw-r--r--   0        0        0      313 2023-04-15 18:00:26.309547 balcony-0.0.87/balcony/custom_yamls/s3.yaml
--rw-r--r--   0        0        0      418 2023-04-09 17:40:20.070136 balcony-0.0.87/balcony/errors.py
--rw-r--r--   0        0        0    48117 2023-04-29 22:05:26.837497 balcony-0.0.87/balcony/nodes.py
--rw-r--r--   0        0        0    17113 2023-04-30 23:06:55.492084 balcony-0.0.87/balcony/reader.py
--rw-r--r--   0        0        0     3226 2023-04-15 19:59:07.673952 balcony-0.0.87/balcony/registries.py
--rw-r--r--   0        0        0    13165 2023-04-09 17:39:54.863685 balcony-0.0.87/balcony/relations.py
--rw-r--r--   0        0        0     2533 2023-04-21 19:19:57.046512 balcony-0.0.87/balcony/test.py
--rw-r--r--   0        0        0     4513 2023-04-30 23:07:39.925984 balcony-0.0.87/balcony/utils.py
--rw-r--r--   0        0        0     2739 2023-04-30 21:55:13.504191 balcony-0.0.87/balcony/yaml_config.py
--rw-r--r--   0        0        0     2049 2023-04-29 22:16:26.774034 balcony-0.0.87/balcony/yaml_validators.py
--rw-r--r--   0        0        0      664 2023-04-30 23:10:02.436599 balcony-0.0.87/pyproject.toml
--rw-r--r--   0        0        0     2949 1970-01-01 00:00:00.000000 balcony-0.0.87/setup.py
--rw-r--r--   0        0        0     2865 1970-01-01 00:00:00.000000 balcony-0.0.87/PKG-INFO
...
### Comparing `balcony-0.0.87/LICENSE` & `balcony-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `balcony-0.0.87/balcony/botocore_utils.py` & `balcony-0.0.9/balcony/botocore_utils.py`
...
### Comparing `balcony-0.0.87/balcony/custom_nodes/lambda_functions.py` & `balcony-0.0.9/balcony/custom_nodes/lambda_functions.py`
...
### Comparing `balcony-0.0.87/balcony/custom_nodes/s3.py` & `balcony-0.0.9/balcony/custom_nodes/s3.py`
...
### Comparing `balcony-0.0.87/pyproject.toml` & `balcony-0.0.9/pyproject.toml`
