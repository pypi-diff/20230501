# Comparing `tmp/cdk8s-operator-0.1.97.tar.gz` & `tmp/cdk8s-operator-0.1.98.tar.gz`
...
## Comparing `cdk8s-operator-0.1.97.tar` & `cdk8s-operator-0.1.98.tar`
...
### Comparing `cdk8s-operator-0.1.97/LICENSE` & `cdk8s-operator-0.1.98/LICENSE`

 * *Files identical despite different names*

### Comparing `cdk8s-operator-0.1.97/PKG-INFO` & `cdk8s-operator-0.1.98/PKG-INFO`
...
### Comparing `cdk8s-operator-0.1.97/README.md` & `cdk8s-operator-0.1.98/README.md`

 * *Files identical despite different names*

### Comparing `cdk8s-operator-0.1.97/setup.py` & `cdk8s-operator-0.1.98/setup.py`
...
### Comparing `cdk8s-operator-0.1.97/src/cdk8s_operator/__init__.py` & `cdk8s-operator-0.1.98/src/cdk8s_operator/__init__.py`

 * *Files identical despite different names*

### Comparing `cdk8s-operator-0.1.97/src/cdk8s_operator.egg-info/PKG-INFO` & `cdk8s-operator-0.1.98/src/cdk8s_operator.egg-info/PKG-INFO`
