# Comparing `tmp/dbt_lineage_viewer-0.2.tar.gz` & `tmp/dbt_lineage_viewer-0.3.tar.gz`
...
## Comparing `dbt_lineage_viewer-0.2.tar` & `dbt_lineage_viewer-0.3.tar`
...
### Comparing `dbt_lineage_viewer-0.2/PKG-INFO` & `dbt_lineage_viewer-0.3/PKG-INFO`
...
### Comparing `dbt_lineage_viewer-0.2/README.md` & `dbt_lineage_viewer-0.3/README.md`

 * *Files identical despite different names*

### Comparing `dbt_lineage_viewer-0.2/dbt_lineage_viewer.egg-info/PKG-INFO` & `dbt_lineage_viewer-0.3/dbt_lineage_viewer.egg-info/PKG-INFO`
...
### Comparing `dbt_lineage_viewer-0.2/setup.py` & `dbt_lineage_viewer-0.3/setup.py`
