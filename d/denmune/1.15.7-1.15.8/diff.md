# Comparing `tmp/denmune-1.15.7.tar.gz` & `tmp/denmune-1.15.8.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "denmune-1.15.7.tar", last modified: Mon May  1 00:38:55 2023, max compression
+gzip compressed data, was "denmune-1.15.8.tar", last modified: Mon May  1 00:43:39 2023, max compression
```

## Comparing `denmune-1.15.7.tar` & `denmune-1.15.8.tar`

### file list

```diff
@@ -1,18 +1,18 @@
-drwxrwxrwx   0        0        0        0 2023-05-01 00:38:55.868194 denmune-1.15.7/
--rw-rw-rw-   0        0        0     1498 2021-12-31 23:30:13.000000 denmune-1.15.7/LICENSE
--rw-rw-rw-   0        0        0       47 2021-12-27 21:52:58.000000 denmune-1.15.7/MANIFEST.in
--rw-rw-rw-   0        0        0    31200 2023-05-01 00:38:55.870191 denmune-1.15.7/PKG-INFO
--rw-rw-rw-   0        0        0    30529 2023-04-29 21:17:35.000000 denmune-1.15.7/README.md
--rw-rw-rw-   0        0        0      108 2021-12-23 20:19:35.000000 denmune-1.15.7/pyproject.toml
--rw-rw-rw-   0        0        0      810 2023-05-01 00:38:55.875201 denmune-1.15.7/setup.cfg
--rw-rw-rw-   0        0        0      257 2023-05-01 00:38:08.000000 denmune-1.15.7/setup.py
-drwxrwxrwx   0        0        0        0 2023-05-01 00:38:55.811177 denmune-1.15.7/src/
-drwxrwxrwx   0        0        0        0 2023-05-01 00:38:55.841181 denmune-1.15.7/src/denmune/
--rw-rw-rw-   0        0        0       28 2022-05-12 02:48:25.000000 denmune-1.15.7/src/denmune/__init__.py
--rw-rw-rw-   0        0        0    39240 2023-04-30 00:20:12.000000 denmune-1.15.7/src/denmune/denmune.py
-drwxrwxrwx   0        0        0        0 2023-05-01 00:38:55.861177 denmune-1.15.7/src/denmune.egg-info/
--rw-rw-rw-   0        0        0    31200 2023-05-01 00:38:55.000000 denmune-1.15.7/src/denmune.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      284 2023-05-01 00:38:55.000000 denmune-1.15.7/src/denmune.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-05-01 00:38:55.000000 denmune-1.15.7/src/denmune.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0      123 2023-05-01 00:38:55.000000 denmune-1.15.7/src/denmune.egg-info/requires.txt
--rw-rw-rw-   0        0        0        8 2023-05-01 00:38:55.000000 denmune-1.15.7/src/denmune.egg-info/top_level.txt
...
### Comparing `denmune-1.15.7/LICENSE` & `denmune-1.15.8/LICENSE`

 * *Files identical despite different names*

### Comparing `denmune-1.15.7/PKG-INFO` & `denmune-1.15.8/PKG-INFO`
...
### Comparing `denmune-1.15.7/README.md` & `denmune-1.15.8/README.md`

 * *Files identical despite different names*

### Comparing `denmune-1.15.7/setup.cfg` & `denmune-1.15.8/setup.cfg`
...
-00000020: 696f 6e20 3d20 312e 3135 2e37 0d0a 6175  ion = 1.15.7..au
...
### Comparing `denmune-1.15.7/src/denmune/denmune.py` & `denmune-1.15.8/src/denmune/denmune.py`

 * *Files identical despite different names*

### Comparing `denmune-1.15.7/src/denmune.egg-info/PKG-INFO` & `denmune-1.15.8/src/denmune.egg-info/PKG-INFO`
