# Comparing `tmp/glitter_sdk-0.2.1.tar.gz` & `tmp/glitter_sdk-0.2.2.tar.gz`
...
### Comparing `glitter_sdk-0.2.1/glitter_sdk/core/multisig.py` & `glitter_sdk-0.2.2/glitter_sdk/core/multisig.py`
