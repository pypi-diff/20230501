# Comparing `tmp/hugchat-0.0.4.tar.gz` & `tmp/hugchat-0.0.5.tar.gz`
...
+gzip compressed data, was "hugchat-0.0.5.tar", last modified: Mon May  1 17:46:57 2023, max compression
```

## Comparing `hugchat-0.0.4.tar` & `hugchat-0.0.5.tar`
...
+drwxrwxrwx   0 codespace  (1000) codespace  (1000)        0 2023-05-01 17:46:57.228374 hugchat-0.0.5/
+-rw-rw-rw-   0 codespace  (1000) codespace  (1000)    34523 2023-05-01 00:33:11.000000 hugchat-0.0.5/LICENSE
+-rw-rw-rw-   0 codespace  (1000) codespace  (1000)     1688 2023-05-01 17:46:57.228374 hugchat-0.0.5/PKG-INFO
+-rw-rw-rw-   0 codespace  (1000) codespace  (1000)      670 2023-05-01 00:33:11.000000 hugchat-0.0.5/README.md
+-rw-rw-rw-   0 codespace  (1000) codespace  (1000)       38 2023-05-01 17:46:57.228374 hugchat-0.0.5/setup.cfg
+-rw-rw-rw-   0 codespace  (1000) codespace  (1000)     1405 2023-05-01 17:46:50.000000 hugchat-0.0.5/setup.py
+drwxrwxrwx   0 codespace  (1000) codespace  (1000)        0 2023-05-01 17:46:57.220373 hugchat-0.0.5/src/
+drwxrwxrwx   0 codespace  (1000) codespace  (1000)        0 2023-05-01 17:46:57.224373 hugchat-0.0.5/src/hugchat/
+-rw-rw-rw-   0 codespace  (1000) codespace  (1000)     4673 2023-05-01 17:39:58.000000 hugchat-0.0.5/src/hugchat/hugchat.py
+drwxrwxrwx   0 codespace  (1000) codespace  (1000)        0 2023-05-01 17:46:57.228374 hugchat-0.0.5/src/hugchat.egg-info/
+-rw-rw-rw-   0 codespace  (1000) codespace  (1000)     1688 2023-05-01 17:46:56.000000 hugchat-0.0.5/src/hugchat.egg-info/PKG-INFO
+-rw-rw-rw-   0 codespace  (1000) codespace  (1000)      223 2023-05-01 17:46:57.000000 hugchat-0.0.5/src/hugchat.egg-info/SOURCES.txt
+-rw-rw-rw-   0 codespace  (1000) codespace  (1000)        1 2023-05-01 17:46:56.000000 hugchat-0.0.5/src/hugchat.egg-info/dependency_links.txt
+-rw-rw-rw-   0 codespace  (1000) codespace  (1000)        9 2023-05-01 17:46:56.000000 hugchat-0.0.5/src/hugchat.egg-info/requires.txt
+-rw-rw-rw-   0 codespace  (1000) codespace  (1000)        8 2023-05-01 17:46:56.000000 hugchat-0.0.5/src/hugchat.egg-info/top_level.txt
```

### Comparing `hugchat-0.0.4/LICENSE` & `hugchat-0.0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `hugchat-0.0.4/PKG-INFO` & `hugchat-0.0.5/PKG-INFO`
...
### Comparing `hugchat-0.0.4/README.md` & `hugchat-0.0.5/README.md`

 * *Files identical despite different names*

### Comparing `hugchat-0.0.4/setup.py` & `hugchat-0.0.5/setup.py`
...
### Comparing `hugchat-0.0.4/src/hugchat/hugchat.py` & `hugchat-0.0.5/src/hugchat/hugchat.py`
...
### Comparing `hugchat-0.0.4/src/hugchat.egg-info/PKG-INFO` & `hugchat-0.0.5/src/hugchat.egg-info/PKG-INFO`
