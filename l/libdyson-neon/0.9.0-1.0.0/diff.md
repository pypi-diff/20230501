# Comparing `tmp/libdyson-neon-0.9.0.tar.gz` & `tmp/libdyson-neon-1.0.0.tar.gz`
...
## Comparing `libdyson-neon-0.9.0.tar` & `libdyson-neon-1.0.0.tar`
...
### Comparing `libdyson-neon-0.9.0/LICENSE` & `libdyson-neon-1.0.0/LICENSE`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/PKG-INFO` & `libdyson-neon-1.0.0/PKG-INFO`
...
### Comparing `libdyson-neon-0.9.0/libdyson/__init__.py` & `libdyson-neon-1.0.0/libdyson/__init__.py`
...
### Comparing `libdyson-neon-0.9.0/libdyson/cloud/account.py` & `libdyson-neon-1.0.0/libdyson/cloud/account.py`
...
### Comparing `libdyson-neon-0.9.0/libdyson/cloud/cloud_360_eye.py` & `libdyson-neon-1.0.0/libdyson/cloud/cloud_360_eye.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/libdyson/cloud/device_info.py` & `libdyson-neon-1.0.0/libdyson/cloud/device_info.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/libdyson/cloud/regions.py` & `libdyson-neon-1.0.0/libdyson/cloud/regions.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/libdyson/cloud/utils.py` & `libdyson-neon-1.0.0/libdyson/cloud/utils.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/libdyson/const.py` & `libdyson-neon-1.0.0/libdyson/const.py`
...
### Comparing `libdyson-neon-0.9.0/libdyson/discovery.py` & `libdyson-neon-1.0.0/libdyson/discovery.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/libdyson/dyson_360_eye.py` & `libdyson-neon-1.0.0/libdyson/dyson_360_eye.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/libdyson/dyson_360_heurist.py` & `libdyson-neon-1.0.0/libdyson/dyson_360_heurist.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/libdyson/dyson_device.py` & `libdyson-neon-1.0.0/libdyson/dyson_device.py`
...
### Comparing `libdyson-neon-0.9.0/libdyson/dyson_pure_cool.py` & `libdyson-neon-1.0.0/libdyson/dyson_pure_cool.py`
...
### Comparing `libdyson-neon-0.9.0/libdyson/dyson_pure_cool_link.py` & `libdyson-neon-1.0.0/libdyson/dyson_pure_cool_link.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/libdyson/dyson_pure_hot_cool_link.py` & `libdyson-neon-1.0.0/libdyson/dyson_pure_hot_cool_link.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/libdyson/dyson_pure_humidify_cool.py` & `libdyson-neon-1.0.0/libdyson/dyson_pure_humidify_cool.py`
...
### Comparing `libdyson-neon-0.9.0/libdyson/dyson_vacuum_device.py` & `libdyson-neon-1.0.0/libdyson/dyson_vacuum_device.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/libdyson/exceptions.py` & `libdyson-neon-1.0.0/libdyson/exceptions.py`
...
### Comparing `libdyson-neon-0.9.0/libdyson/utils.py` & `libdyson-neon-1.0.0/libdyson/utils.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/libdyson_neon.egg-info/PKG-INFO` & `libdyson-neon-1.0.0/libdyson_neon.egg-info/PKG-INFO`
...
### Comparing `libdyson-neon-0.9.0/libdyson_neon.egg-info/SOURCES.txt` & `libdyson-neon-1.0.0/libdyson_neon.egg-info/SOURCES.txt`
...
### Comparing `libdyson-neon-0.9.0/pyproject.toml` & `libdyson-neon-1.0.0/pyproject.toml`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/setup.cfg` & `libdyson-neon-1.0.0/setup.cfg`
...
### Comparing `libdyson-neon-0.9.0/tests/cloud/mocked_requests.py` & `libdyson-neon-1.0.0/tests/cloud/mocked_requests.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/tests/cloud/test_bearer_auth.py` & `libdyson-neon-1.0.0/tests/cloud/test_bearer_auth.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/tests/cloud/test_cloud_360_eye.py` & `libdyson-neon-1.0.0/tests/cloud/test_cloud_360_eye.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/tests/cloud/test_dyson_account.py` & `libdyson-neon-1.0.0/tests/cloud/test_dyson_account.py`
...
### Comparing `libdyson-neon-0.9.0/tests/cloud/utils.py` & `libdyson-neon-1.0.0/tests/cloud/utils.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/tests/conftest.py` & `libdyson-neon-1.0.0/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/tests/mocked_mqtt.py` & `libdyson-neon-1.0.0/tests/mocked_mqtt.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/tests/test_360_eye.py` & `libdyson-neon-1.0.0/tests/test_360_eye.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/tests/test_360_heurist.py` & `libdyson-neon-1.0.0/tests/test_360_heurist.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/tests/test_device.py` & `libdyson-neon-1.0.0/tests/test_device.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/tests/test_discovery.py` & `libdyson-neon-1.0.0/tests/test_discovery.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/tests/test_fan_device.py` & `libdyson-neon-1.0.0/tests/test_fan_device.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/tests/test_heating_device.py` & `libdyson-neon-1.0.0/tests/test_heating_device.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/tests/test_init.py` & `libdyson-neon-1.0.0/tests/test_init.py`
...
### Comparing `libdyson-neon-0.9.0/tests/test_pure_cool.py` & `libdyson-neon-1.0.0/tests/test_pure_cool.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/tests/test_pure_cool_formaldehyde.py` & `libdyson-neon-1.0.0/tests/test_pure_cool_missing_env_data.py`
...
### Comparing `libdyson-neon-0.9.0/tests/test_pure_cool_link.py` & `libdyson-neon-1.0.0/tests/test_pure_cool_link.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/tests/test_pure_hot_cool_link.py` & `libdyson-neon-1.0.0/tests/test_pure_hot_cool_link.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/tests/test_pure_humidify_cool.py` & `libdyson-neon-1.0.0/tests/test_pure_humidify_cool.py`
...
### Comparing `libdyson-neon-0.9.0/tests/test_purifier_humidify_cool_formaldehyde.py` & `libdyson-neon-1.0.0/tests/test_purifier_humidify_cool_formaldehyde.py`
...
### Comparing `libdyson-neon-0.9.0/tests/test_utils.py` & `libdyson-neon-1.0.0/tests/test_utils.py`

 * *Files identical despite different names*

### Comparing `libdyson-neon-0.9.0/tests/test_vacuum.py` & `libdyson-neon-1.0.0/tests/test_vacuum.py`
