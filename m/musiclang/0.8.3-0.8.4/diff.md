# Comparing `tmp/musiclang-0.8.3.tar.gz` & `tmp/musiclang-0.8.4.tar.gz`
...
### Comparing `musiclang-0.8.3/musiclang/predict/predictors/huggin.py` & `musiclang-0.8.4/musiclang/predict/predictors/huggin.py`
...
### Comparing `musiclang-0.8.3/musiclang/predict/predictors/windowed.py` & `musiclang-0.8.4/musiclang/predict/predictors/windowed.py`
...
### Comparing `musiclang-0.8.3/musiclang/transform/composing/patternator.py` & `musiclang-0.8.4/musiclang/transform/composing/patternator.py`
...
### Comparing `musiclang-0.8.3/musiclang/transform/orchestrations/epic.py` & `musiclang-0.8.4/musiclang/transform/orchestrations/epic.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/transform/orchestrations/nocturne.py` & `musiclang-0.8.4/musiclang/transform/orchestrations/nocturne.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/transform/pipeline.py` & `musiclang-0.8.4/musiclang/transform/pipeline.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/transform/score_merger/basics.py` & `musiclang-0.8.4/musiclang/transform/score_merger/basics.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/transform/structure_graphs/forms.py` & `musiclang-0.8.4/musiclang/transform/structure_graphs/forms.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/transform/transformer.py` & `musiclang-0.8.4/musiclang/transform/transformer.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/transform/utils_random.py` & `musiclang-0.8.4/musiclang/transform/utils_random.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/arrange_utils/arrange_utils.py` & `musiclang-0.8.4/musiclang/write/arrange_utils/arrange_utils.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/arrange_utils/skyline_algorithm.py` & `musiclang-0.8.4/musiclang/write/arrange_utils/skyline_algorithm.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/chord.py` & `musiclang-0.8.4/musiclang/write/chord.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/constants.py` & `musiclang-0.8.4/musiclang/write/constants.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/element.py` & `musiclang-0.8.4/musiclang/write/element.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/elements/chord.py` & `musiclang-0.8.4/musiclang/write/elements/chord.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/library.py` & `musiclang-0.8.4/musiclang/write/library.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/melody.py` & `musiclang-0.8.4/musiclang/write/melody.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/note.py` & `musiclang-0.8.4/musiclang/write/note.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/note_pitch.py` & `musiclang-0.8.4/musiclang/write/note_pitch.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/ornementation.py` & `musiclang-0.8.4/musiclang/write/ornementation.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/out/constants.py` & `musiclang-0.8.4/musiclang/write/out/constants.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/out/midi_utils.py` & `musiclang-0.8.4/musiclang/write/out/midi_utils.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/out/to_code.py` & `musiclang-0.8.4/musiclang/write/out/to_code.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/out/to_midi.py` & `musiclang-0.8.4/musiclang/write/out/to_midi.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/out/to_mxl.py` & `musiclang-0.8.4/musiclang/write/out/to_mxl.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/pitches/pitches_utils.py` & `musiclang-0.8.4/musiclang/write/pitches/pitches_utils.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/properties/note_properties.py` & `musiclang-0.8.4/musiclang/write/properties/note_properties.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/rhythm/metric.py` & `musiclang-0.8.4/musiclang/write/rhythm/metric.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/rhythm/score_rythm.py` & `musiclang-0.8.4/musiclang/write/rhythm/score_rythm.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/rhythm/utils_metric.py` & `musiclang-0.8.4/musiclang/write/rhythm/utils_metric.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/score.py` & `musiclang-0.8.4/musiclang/write/score.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/sequence/sequence.py` & `musiclang-0.8.4/musiclang/write/sequence/sequence.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/sequence/sequence_utils.py` & `musiclang-0.8.4/musiclang/write/sequence/sequence_utils.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/time_utils/time_utils.py` & `musiclang-0.8.4/musiclang/write/time_utils/time_utils.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang/write/tonality.py` & `musiclang-0.8.4/musiclang/write/tonality.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/musiclang.egg-info/PKG-INFO` & `musiclang-0.8.4/musiclang.egg-info/PKG-INFO`
...
### Comparing `musiclang-0.8.3/musiclang.egg-info/SOURCES.txt` & `musiclang-0.8.4/musiclang.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/pyproject.toml` & `musiclang-0.8.4/pyproject.toml`
...
### Comparing `musiclang-0.8.3/setup.py` & `musiclang-0.8.4/setup.py`
...
### Comparing `musiclang-0.8.3/tests/analyze/test_score_formatter.py` & `musiclang-0.8.4/tests/analyze/test_score_formatter.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/composing/test_project.py` & `musiclang-0.8.4/tests/composing/test_project.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/composing/test_voice_leading.py` & `musiclang-0.8.4/tests/composing/test_voice_leading.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/predict/test_auto_composer.py` & `musiclang-0.8.4/tests/predict/test_auto_composer.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/transform/test_mask.py` & `musiclang-0.8.4/tests/transform/test_mask.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/transform/test_pipeline.py` & `musiclang-0.8.4/tests/transform/test_pipeline.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/transform/test_transforms.py` & `musiclang-0.8.4/tests/transform/test_transforms.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/write/out/test_to_midi.py` & `musiclang-0.8.4/tests/write/out/test_to_midi.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/write/pitches/test_pitches_utils.py` & `musiclang-0.8.4/tests/write/pitches/test_pitches_utils.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/write/properties/test_note_properties.py` & `musiclang-0.8.4/tests/write/properties/test_note_properties.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/write/rythm/test_metric.py` & `musiclang-0.8.4/tests/write/rythm/test_metric.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/write/test_bass_notes.py` & `musiclang-0.8.4/tests/write/test_bass_notes.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/write/test_chord.py` & `musiclang-0.8.4/tests/write/test_chord.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/write/test_chord_notes.py` & `musiclang-0.8.4/tests/write/test_chord_notes.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/write/test_drum_notes.py` & `musiclang-0.8.4/tests/write/test_drum_notes.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/write/test_extensions.py` & `musiclang-0.8.4/tests/write/test_extensions.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/write/test_note.py` & `musiclang-0.8.4/tests/write/test_note.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/write/test_score.py` & `musiclang-0.8.4/tests/write/test_score.py`

 * *Files identical despite different names*

### Comparing `musiclang-0.8.3/tests/write/test_tonality.py` & `musiclang-0.8.4/tests/write/test_tonality.py`
