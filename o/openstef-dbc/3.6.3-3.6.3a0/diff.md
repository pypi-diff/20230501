# Comparing `tmp/openstef_dbc-3.6.3.tar.gz` & `tmp/openstef_dbc-3.6.3a0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "openstef_dbc-3.6.3.tar", last modified: Mon May  1 15:11:02 2023, max compression
+gzip compressed data, was "openstef_dbc-3.6.3a0.tar", last modified: Wed Apr 19 13:44:50 2023, max compression
```

## Comparing `openstef_dbc-3.6.3.tar` & `openstef_dbc-3.6.3a0.tar`

### file list

```diff
@@ -1,38 +1,38 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-01 15:11:02.153109 openstef_dbc-3.6.3/
--rw-r--r--   0 runner    (1001) docker     (123)    14907 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)     3360 2023-05-01 15:11:02.153109 openstef_dbc-3.6.3/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     2600 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-01 15:11:02.153109 openstef_dbc-3.6.3/openstef_dbc/
--rw-r--r--   0 runner    (1001) docker     (123)      885 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      150 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/__main__.py
--rw-r--r--   0 runner    (1001) docker     (123)     9192 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/data_interface.py
--rw-r--r--   0 runner    (1001) docker     (123)     5451 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/database.py
--rw-r--r--   0 runner    (1001) docker     (123)    13520 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/ktp_api.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-01 15:11:02.153109 openstef_dbc-3.6.3/openstef_dbc/log/
--rw-r--r--   0 runner    (1001) docker     (123)      150 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/log/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     8999 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/log/logging.py
--rw-r--r--   0 runner    (1001) docker     (123)     1455 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/log/processors.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-01 15:11:02.153109 openstef_dbc-3.6.3/openstef_dbc/models/
--rw-r--r--   0 runner    (1001) docker     (123)      150 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/models/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      633 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/models/measurement.py
--rw-r--r--   0 runner    (1001) docker     (123)      510 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/models/switch_state.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-01 15:11:02.153109 openstef_dbc-3.6.3/openstef_dbc/services/
--rw-r--r--   0 runner    (1001) docker     (123)      150 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/services/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)    13348 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/services/ems.py
--rw-r--r--   0 runner    (1001) docker     (123)     9478 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/services/model_input.py
--rw-r--r--   0 runner    (1001) docker     (123)    14166 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/services/prediction_job.py
--rw-r--r--   0 runner    (1001) docker     (123)    14427 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/services/predictions.py
--rw-r--r--   0 runner    (1001) docker     (123)     9948 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/services/predictor.py
--rw-r--r--   0 runner    (1001) docker     (123)     9319 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/services/splitting.py
--rw-r--r--   0 runner    (1001) docker     (123)     5542 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/services/systems.py
--rw-r--r--   0 runner    (1001) docker     (123)    14263 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/services/weather.py
--rw-r--r--   0 runner    (1001) docker     (123)    15440 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/services/write.py
--rw-r--r--   0 runner    (1001) docker     (123)     1670 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/openstef_dbc/utils.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-01 15:11:02.153109 openstef_dbc-3.6.3/openstef_dbc.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     3360 2023-05-01 15:11:02.000000 openstef_dbc-3.6.3/openstef_dbc.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      902 2023-05-01 15:11:02.000000 openstef_dbc-3.6.3/openstef_dbc.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-01 15:11:02.000000 openstef_dbc-3.6.3/openstef_dbc.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)      148 2023-05-01 15:11:02.000000 openstef_dbc-3.6.3/openstef_dbc.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       13 2023-05-01 15:11:02.000000 openstef_dbc-3.6.3/openstef_dbc.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)      164 2023-05-01 15:11:02.153109 openstef_dbc-3.6.3/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     2103 2023-05-01 15:10:49.000000 openstef_dbc-3.6.3/setup.py
...
### Comparing `openstef_dbc-3.6.3/LICENSE` & `openstef_dbc-3.6.3a0/LICENSE`

 * *Files identical despite different names*

### Comparing `openstef_dbc-3.6.3/PKG-INFO` & `openstef_dbc-3.6.3a0/PKG-INFO`
...
### Comparing `openstef_dbc-3.6.3/README.md` & `openstef_dbc-3.6.3a0/README.md`

 * *Files identical despite different names*

### Comparing `openstef_dbc-3.6.3/openstef_dbc/__init__.py` & `openstef_dbc-3.6.3a0/openstef_dbc/__init__.py`

 * *Files identical despite different names*

### Comparing `openstef_dbc-3.6.3/openstef_dbc/data_interface.py` & `openstef_dbc-3.6.3a0/openstef_dbc/data_interface.py`

 * *Files identical despite different names*

### Comparing `openstef_dbc-3.6.3/openstef_dbc/database.py` & `openstef_dbc-3.6.3a0/openstef_dbc/database.py`
...
### Comparing `openstef_dbc-3.6.3/openstef_dbc/ktp_api.py` & `openstef_dbc-3.6.3a0/openstef_dbc/ktp_api.py`

 * *Files identical despite different names*

### Comparing `openstef_dbc-3.6.3/openstef_dbc/log/logging.py` & `openstef_dbc-3.6.3a0/openstef_dbc/log/logging.py`

 * *Files identical despite different names*

### Comparing `openstef_dbc-3.6.3/openstef_dbc/log/processors.py` & `openstef_dbc-3.6.3a0/openstef_dbc/log/processors.py`

 * *Files identical despite different names*

### Comparing `openstef_dbc-3.6.3/openstef_dbc/models/measurement.py` & `openstef_dbc-3.6.3a0/openstef_dbc/models/measurement.py`

 * *Files identical despite different names*

### Comparing `openstef_dbc-3.6.3/openstef_dbc/services/ems.py` & `openstef_dbc-3.6.3a0/openstef_dbc/services/ems.py`
...
### Comparing `openstef_dbc-3.6.3/openstef_dbc/services/model_input.py` & `openstef_dbc-3.6.3a0/openstef_dbc/services/model_input.py`

 * *Files identical despite different names*

### Comparing `openstef_dbc-3.6.3/openstef_dbc/services/prediction_job.py` & `openstef_dbc-3.6.3a0/openstef_dbc/services/prediction_job.py`
...
### Comparing `openstef_dbc-3.6.3/openstef_dbc/services/predictions.py` & `openstef_dbc-3.6.3a0/openstef_dbc/services/predictions.py`
...
### Comparing `openstef_dbc-3.6.3/openstef_dbc/services/predictor.py` & `openstef_dbc-3.6.3a0/openstef_dbc/services/predictor.py`

 * *Files identical despite different names*

### Comparing `openstef_dbc-3.6.3/openstef_dbc/services/splitting.py` & `openstef_dbc-3.6.3a0/openstef_dbc/services/splitting.py`

 * *Files identical despite different names*

### Comparing `openstef_dbc-3.6.3/openstef_dbc/services/systems.py` & `openstef_dbc-3.6.3a0/openstef_dbc/services/systems.py`
...
### Comparing `openstef_dbc-3.6.3/openstef_dbc/services/weather.py` & `openstef_dbc-3.6.3a0/openstef_dbc/services/weather.py`

 * *Files identical despite different names*

### Comparing `openstef_dbc-3.6.3/openstef_dbc/services/write.py` & `openstef_dbc-3.6.3a0/openstef_dbc/services/write.py`
...
### Comparing `openstef_dbc-3.6.3/openstef_dbc/utils.py` & `openstef_dbc-3.6.3a0/openstef_dbc/utils.py`

 * *Files identical despite different names*

### Comparing `openstef_dbc-3.6.3/openstef_dbc.egg-info/PKG-INFO` & `openstef_dbc-3.6.3a0/openstef_dbc.egg-info/PKG-INFO`
...
### Comparing `openstef_dbc-3.6.3/openstef_dbc.egg-info/SOURCES.txt` & `openstef_dbc-3.6.3a0/openstef_dbc.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `openstef_dbc-3.6.3/setup.py` & `openstef_dbc-3.6.3a0/setup.py`
