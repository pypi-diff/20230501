# Comparing `tmp/pyqodeng-0.0.7.tar.gz` & `tmp/pyqodeng-0.0.8.tar.gz`
...
### Comparing `pyqodeng-0.0.7/.coveragerc` & `pyqodeng-0.0.8/.coveragerc`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/CHANGELOG.rst` & `pyqodeng-0.0.8/CHANGELOG.rst`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/CONTRIBUTING.rst` & `pyqodeng-0.0.8/CONTRIBUTING.rst`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/LICENSE` & `pyqodeng-0.0.8/LICENSE`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/PKG-INFO` & `pyqodeng-0.0.8/PKG-INFO`
...
### Comparing `pyqodeng-0.0.7/README.rst` & `pyqodeng-0.0.8/README.rst`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/conftest.py` & `pyqodeng-0.0.8/conftest.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/doc/Makefile` & `pyqodeng-0.0.8/doc/Makefile`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/doc/make.bat` & `pyqodeng-0.0.8/doc/make.bat`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/doc/source/_static/editor_widget.png` & `pyqodeng-0.0.8/doc/source/_static/editor_widget.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/doc/source/conf.py` & `pyqodeng-0.0.8/doc/source/conf.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/doc/source/examples.rst` & `pyqodeng-0.0.8/doc/source/examples.rst`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/doc/source/index.rst` & `pyqodeng-0.0.8/doc/source/index.rst`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/doc/source/pyqode.core.api.rst` & `pyqodeng-0.0.8/doc/source/pyqode.core.api.rst`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/doc/source/pyqode.core.backend.rst` & `pyqodeng-0.0.8/doc/source/pyqode.core.backend.rst`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/doc/source/pyqode.core.dialogs.rst` & `pyqodeng-0.0.8/doc/source/pyqode.core.dialogs.rst`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/doc/source/pyqode.core.managers.rst` & `pyqodeng-0.0.8/doc/source/pyqode.core.managers.rst`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/doc/source/pyqode.core.modes.rst` & `pyqodeng-0.0.8/doc/source/pyqode.core.modes.rst`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/doc/source/pyqode.core.panels.rst` & `pyqodeng-0.0.8/doc/source/pyqode.core.panels.rst`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/doc/source/pyqode.core.rst` & `pyqodeng-0.0.8/doc/source/pyqode.core.rst`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/doc/source/pyqode.core.widgets.rst` & `pyqodeng-0.0.8/doc/source/pyqode.core.widgets.rst`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/encodings/common.py` & `pyqodeng-0.0.8/examples/encodings/common.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/encodings/detect.py` & `pyqodeng-0.0.8/examples/encodings/detect.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/encodings/dialog.py` & `pyqodeng-0.0.8/examples/encodings/dialog.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/encodings/menu.py` & `pyqodeng-0.0.8/examples/encodings/menu.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/encodings/readme.rst` & `pyqodeng-0.0.8/examples/encodings/readme.rst`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/modes/autocomplete.py` & `pyqodeng-0.0.8/examples/modes/autocomplete.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/modes/autoindent.py` & `pyqodeng-0.0.8/examples/modes/autoindent.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/modes/caret_line_highlighter_with_syntax_highlighter.py` & `pyqodeng-0.0.8/examples/modes/caret_line_highlighter_with_syntax_highlighter.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/modes/caret_line_highlighter_without_syntax_highlighter.py` & `pyqodeng-0.0.8/examples/modes/caret_line_highlighter_without_syntax_highlighter.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/modes/case_converter.py` & `pyqodeng-0.0.8/examples/modes/case_converter.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/modes/checker.py` & `pyqodeng-0.0.8/examples/modes/checker.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/modes/code_completion_backend.py` & `pyqodeng-0.0.8/examples/modes/code_completion_backend.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/modes/code_completion_frontend.py` & `pyqodeng-0.0.8/examples/modes/code_completion_frontend.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/modes/extended_selections.py` & `pyqodeng-0.0.8/examples/modes/extended_selections.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/modes/filewatcher.py` & `pyqodeng-0.0.8/examples/modes/filewatcher.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/modes/indenter.py` & `pyqodeng-0.0.8/examples/modes/indenter.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/modes/occurences.py` & `pyqodeng-0.0.8/examples/modes/occurences.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/modes/pygments_syntax_highlighter.py` & `pyqodeng-0.0.8/examples/modes/pygments_syntax_highlighter.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/modes/right_margin.py` & `pyqodeng-0.0.8/examples/modes/right_margin.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/modes/smart_backspace.py` & `pyqodeng-0.0.8/examples/modes/smart_backspace.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/modes/symbol_matcher.py` & `pyqodeng-0.0.8/examples/modes/symbol_matcher.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/modes/zoom.py` & `pyqodeng-0.0.8/examples/modes/zoom.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/LICENSE` & `pyqodeng-0.0.8/examples/notepad/LICENSE`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/forms/about.png` & `pyqodeng-0.0.8/examples/notepad/forms/about.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/forms/close.png` & `pyqodeng-0.0.8/examples/notepad/forms/close.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/forms/document-new.png` & `pyqodeng-0.0.8/examples/notepad/forms/document-new.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/forms/document-open.png` & `pyqodeng-0.0.8/examples/notepad/forms/document-open.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/forms/document-save-as.png` & `pyqodeng-0.0.8/examples/notepad/forms/document-save-as.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/forms/document-save.png` & `pyqodeng-0.0.8/examples/notepad/forms/document-save.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/forms/main_window.ui` & `pyqodeng-0.0.8/examples/notepad/forms/main_window.ui`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/forms/pyqode.png` & `pyqodeng-0.0.8/examples/notepad/forms/pyqode.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/freeze_setup.py` & `pyqodeng-0.0.8/examples/notepad/freeze_setup.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/notepad/__init__.py` & `pyqodeng-0.0.8/examples/notepad/notepad/__init__.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/notepad/editor.py` & `pyqodeng-0.0.8/examples/notepad/notepad/editor.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/notepad/forms/main_window_ui.py` & `pyqodeng-0.0.8/examples/notepad/notepad/forms/main_window_ui.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/notepad/forms/resources_rc.py` & `pyqodeng-0.0.8/examples/notepad/notepad/forms/resources_rc.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/notepad/main_window.py` & `pyqodeng-0.0.8/examples/notepad/notepad/main_window.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/readme.rst` & `pyqodeng-0.0.8/examples/notepad/readme.rst`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/setup.iss` & `pyqodeng-0.0.8/examples/notepad/setup.iss`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/setup.py` & `pyqodeng-0.0.8/examples/notepad/setup.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/share/notepad.ico` & `pyqodeng-0.0.8/examples/notepad/share/notepad.ico`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/notepad/share/notepad.png` & `pyqodeng-0.0.8/examples/notepad/share/notepad.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/panels/checker.py` & `pyqodeng-0.0.8/examples/panels/checker.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/panels/folding.py` & `pyqodeng-0.0.8/examples/panels/folding.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/panels/global_checker.py` & `pyqodeng-0.0.8/examples/panels/global_checker.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/panels/line_numbers.py` & `pyqodeng-0.0.8/examples/panels/line_numbers.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/panels/search_and_replace.py` & `pyqodeng-0.0.8/examples/panels/search_and_replace.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/simple/basic.py` & `pyqodeng-0.0.8/examples/simple/basic.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/simple/custom_actions.py` & `pyqodeng-0.0.8/examples/simple/custom_actions.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/simple/style_and_settings.py` & `pyqodeng-0.0.8/examples/simple/style_and_settings.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/widgets/filesystem_treeview.py` & `pyqodeng-0.0.8/examples/widgets/filesystem_treeview.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/widgets/generic_code_edit.py` & `pyqodeng-0.0.8/examples/widgets/generic_code_edit.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/widgets/interactive_process.py` & `pyqodeng-0.0.8/examples/widgets/interactive_process.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/widgets/splittable_codeedit_tab_widget.py` & `pyqodeng-0.0.8/examples/widgets/splittable_codeedit_tab_widget.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/examples/widgets/splittable_tab_widget.py` & `pyqodeng-0.0.8/examples/widgets/splittable_tab_widget.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/dlg_encodings.ui` & `pyqodeng-0.0.8/forms/dlg_encodings.ui`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/dlg_goto_line.ui` & `pyqodeng-0.0.8/forms/dlg_goto_line.ui`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/dlg_preferred_encodings_editor.ui` & `pyqodeng-0.0.8/forms/dlg_preferred_encodings_editor.ui`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/dlg_unsaved_files.ui` & `pyqodeng-0.0.8/forms/dlg_unsaved_files.ui`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/pnl_encoding.ui` & `pyqodeng-0.0.8/forms/pnl_encoding.ui`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/pnl_read_only.ui` & `pyqodeng-0.0.8/forms/pnl_read_only.ui`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/popup_open_files.ui` & `pyqodeng-0.0.8/forms/popup_open_files.ui`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/pyqode_core.qrc` & `pyqodeng-0.0.8/forms/pyqode_core.qrc`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/SourceCodePro-Bold.ttf` & `pyqodeng-0.0.8/forms/rc/SourceCodePro-Bold.ttf`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/SourceCodePro-Regular.ttf` & `pyqodeng-0.0.8/forms/rc/SourceCodePro-Regular.ttf`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/clear-left.png` & `pyqodeng-0.0.8/forms/rc/clear-left.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/close.png` & `pyqodeng-0.0.8/forms/rc/close.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/dialog-error.png` & `pyqodeng-0.0.8/forms/rc/dialog-error.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/dialog-info.png` & `pyqodeng-0.0.8/forms/rc/dialog-info.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/dialog-warning.png` & `pyqodeng-0.0.8/forms/rc/dialog-warning.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/document-save-as.png` & `pyqodeng-0.0.8/forms/rc/document-save-as.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/document-save.png` & `pyqodeng-0.0.8/forms/rc/document-save.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/edit-copy.png` & `pyqodeng-0.0.8/forms/rc/edit-copy.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/edit-cut.png` & `pyqodeng-0.0.8/forms/rc/edit-cut.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/edit-delete.png` & `pyqodeng-0.0.8/forms/rc/edit-delete.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/edit-find-replace.png` & `pyqodeng-0.0.8/forms/rc/edit-find-replace.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/edit-find.png` & `pyqodeng-0.0.8/forms/rc/edit-find.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/edit-paste.png` & `pyqodeng-0.0.8/forms/rc/edit-paste.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/edit-redo.png` & `pyqodeng-0.0.8/forms/rc/edit-redo.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/edit-select-all.png` & `pyqodeng-0.0.8/forms/rc/edit-select-all.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/edit-trash.png` & `pyqodeng-0.0.8/forms/rc/edit-trash.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/edit-undo.png` & `pyqodeng-0.0.8/forms/rc/edit-undo.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/format-indent-less.png` & `pyqodeng-0.0.8/forms/rc/format-indent-less.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/format-indent-more.png` & `pyqodeng-0.0.8/forms/rc/format-indent-more.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/go-down.png` & `pyqodeng-0.0.8/forms/rc/go-down.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/go-next.png` & `pyqodeng-0.0.8/forms/rc/go-next.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/go-previous.png` & `pyqodeng-0.0.8/forms/rc/go-previous.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/go-up.png` & `pyqodeng-0.0.8/forms/rc/go-up.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/rc/goto-line.png` & `pyqodeng-0.0.8/forms/rc/goto-line.png`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/forms/search_panel.ui` & `pyqodeng-0.0.8/forms/search_panel.ui`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/__init__.py` & `pyqodeng-0.0.8/pyqodeng/core/__init__.py`
...
### Comparing `pyqodeng-0.0.7/pyqodeng/core/_designer_plugins/__init__.py` & `pyqodeng-0.0.8/pyqodeng/core/_designer_plugins/__init__.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/_forms/dlg_encodings_ui.py` & `pyqodeng-0.0.8/pyqodeng/core/_forms/dlg_encodings_ui.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/_forms/dlg_goto_line_ui.py` & `pyqodeng-0.0.8/pyqodeng/core/_forms/dlg_goto_line_ui.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/_forms/dlg_preferred_encodings_editor_ui.py` & `pyqodeng-0.0.8/pyqodeng/core/_forms/dlg_preferred_encodings_editor_ui.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/_forms/dlg_unsaved_files_ui.py` & `pyqodeng-0.0.8/pyqodeng/core/_forms/dlg_unsaved_files_ui.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/_forms/pnl_encoding_ui.py` & `pyqodeng-0.0.8/pyqodeng/core/_forms/pnl_encoding_ui.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/_forms/pnl_read_only_ui.py` & `pyqodeng-0.0.8/pyqodeng/core/_forms/pnl_read_only_ui.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/_forms/popup_open_files_ui.py` & `pyqodeng-0.0.8/pyqodeng/core/_forms/popup_open_files_ui.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/_forms/pyqode_core_rc.py` & `pyqodeng-0.0.8/pyqodeng/core/_forms/pyqode_core_rc.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/_forms/search_panel_ui.py` & `pyqodeng-0.0.8/pyqodeng/core/_forms/search_panel_ui.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/api/__init__.py` & `pyqodeng-0.0.8/pyqodeng/core/api/__init__.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/api/client.py` & `pyqodeng-0.0.8/pyqodeng/core/api/client.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/api/code_edit.py` & `pyqodeng-0.0.8/pyqodeng/core/api/code_edit.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/api/decoration.py` & `pyqodeng-0.0.8/pyqodeng/core/api/decoration.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/api/encodings.py` & `pyqodeng-0.0.8/pyqodeng/core/api/encodings.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/api/folding.py` & `pyqodeng-0.0.8/pyqodeng/core/api/folding.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/api/manager.py` & `pyqodeng-0.0.8/pyqodeng/core/api/manager.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/api/mode.py` & `pyqodeng-0.0.8/pyqodeng/core/api/mode.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/api/panel.py` & `pyqodeng-0.0.8/pyqodeng/core/api/panel.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/api/syntax_highlighter.py` & `pyqodeng-0.0.8/pyqodeng/core/api/syntax_highlighter.py`
...
### Comparing `pyqodeng-0.0.7/pyqodeng/core/api/utils.py` & `pyqodeng-0.0.8/pyqodeng/core/api/utils.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/backend/__init__.py` & `pyqodeng-0.0.8/pyqodeng/core/backend/__init__.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/backend/server.py` & `pyqodeng-0.0.8/pyqodeng/core/backend/server.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/backend/workers.py` & `pyqodeng-0.0.8/pyqodeng/core/backend/workers.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/cache.py` & `pyqodeng-0.0.8/pyqodeng/core/cache.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/dialogs/encodings.py` & `pyqodeng-0.0.8/pyqodeng/core/dialogs/encodings.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/dialogs/goto.py` & `pyqodeng-0.0.8/pyqodeng/core/dialogs/goto.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/dialogs/unsaved_files.py` & `pyqodeng-0.0.8/pyqodeng/core/dialogs/unsaved_files.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/icons.py` & `pyqodeng-0.0.8/pyqodeng/core/icons.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/managers/__init__.py` & `pyqodeng-0.0.8/pyqodeng/core/managers/__init__.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/managers/backend.py` & `pyqodeng-0.0.8/pyqodeng/core/managers/backend.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/managers/decorations.py` & `pyqodeng-0.0.8/pyqodeng/core/managers/decorations.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/managers/file.py` & `pyqodeng-0.0.8/pyqodeng/core/managers/file.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/managers/modes.py` & `pyqodeng-0.0.8/pyqodeng/core/managers/modes.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/managers/panels.py` & `pyqodeng-0.0.8/pyqodeng/core/managers/panels.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/__init__.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/__init__.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/autocomplete.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/autocomplete.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/autoindent.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/autoindent.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/backspace.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/backspace.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/caret_line_highlight.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/caret_line_highlight.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/case_converter.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/case_converter.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/checker.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/checker.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/code_completion.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/code_completion.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/cursor_history.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/cursor_history.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/extended_selection.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/extended_selection.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/filewatcher.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/filewatcher.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/indenter.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/indenter.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/line_highlighter.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/line_highlighter.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/matcher.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/matcher.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/occurences.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/occurences.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/outline.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/outline.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/pygments_sh.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/pygments_sh.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/right_margin.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/right_margin.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/wordclick.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/wordclick.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/modes/zoom.py` & `pyqodeng-0.0.8/pyqodeng/core/modes/zoom.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/panels/__init__.py` & `pyqodeng-0.0.8/pyqodeng/core/panels/__init__.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/panels/checker.py` & `pyqodeng-0.0.8/pyqodeng/core/panels/checker.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/panels/encodings.py` & `pyqodeng-0.0.8/pyqodeng/core/panels/encodings.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/panels/folding.py` & `pyqodeng-0.0.8/pyqodeng/core/panels/folding.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/panels/global_checker.py` & `pyqodeng-0.0.8/pyqodeng/core/panels/global_checker.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/panels/line_number.py` & `pyqodeng-0.0.8/pyqodeng/core/panels/line_number.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/panels/marker.py` & `pyqodeng-0.0.8/pyqodeng/core/panels/marker.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/panels/read_only.py` & `pyqodeng-0.0.8/pyqodeng/core/panels/read_only.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/panels/search_and_replace.py` & `pyqodeng-0.0.8/pyqodeng/core/panels/search_and_replace.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/share.py` & `pyqodeng-0.0.8/pyqodeng/core/share.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/styles/darcula.py` & `pyqodeng-0.0.8/pyqodeng/core/styles/darcula.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/styles/qt.py` & `pyqodeng-0.0.8/pyqodeng/core/styles/qt.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/tools/console.py` & `pyqodeng-0.0.8/pyqodeng/core/tools/console.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/widgets/__init__.py` & `pyqodeng-0.0.8/pyqodeng/core/widgets/__init__.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/widgets/_pty.py` & `pyqodeng-0.0.8/pyqodeng/core/widgets/_pty.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/widgets/code_edits.py` & `pyqodeng-0.0.8/pyqodeng/core/widgets/code_edits.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/widgets/encodings.py` & `pyqodeng-0.0.8/pyqodeng/core/widgets/encodings.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/widgets/errors_table.py` & `pyqodeng-0.0.8/pyqodeng/core/widgets/errors_table.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/widgets/file_icons_provider.py` & `pyqodeng-0.0.8/pyqodeng/core/widgets/file_icons_provider.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/widgets/filesystem_treeview.py` & `pyqodeng-0.0.8/pyqodeng/core/widgets/filesystem_treeview.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/widgets/interactive.py` & `pyqodeng-0.0.8/pyqodeng/core/widgets/interactive.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/widgets/menu_recents.py` & `pyqodeng-0.0.8/pyqodeng/core/widgets/menu_recents.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/widgets/outline.py` & `pyqodeng-0.0.8/pyqodeng/core/widgets/outline.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/widgets/output_window.py` & `pyqodeng-0.0.8/pyqodeng/core/widgets/output_window.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/widgets/preview.py` & `pyqodeng-0.0.8/pyqodeng/core/widgets/preview.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/widgets/prompt_line_edit.py` & `pyqodeng-0.0.8/pyqodeng/core/widgets/prompt_line_edit.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/widgets/splittable_tab_widget.py` & `pyqodeng-0.0.8/pyqodeng/core/widgets/splittable_tab_widget.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/widgets/tab_bar.py` & `pyqodeng-0.0.8/pyqodeng/core/widgets/tab_bar.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/widgets/tabs.py` & `pyqodeng-0.0.8/pyqodeng/core/widgets/tabs.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng/core/widgets/terminal.py` & `pyqodeng-0.0.8/pyqodeng/core/widgets/terminal.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/pyqodeng.egg-info/PKG-INFO` & `pyqodeng-0.0.8/pyqodeng.egg-info/PKG-INFO`
...
### Comparing `pyqodeng-0.0.7/pyqodeng.egg-info/SOURCES.txt` & `pyqodeng-0.0.8/pyqodeng.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/setup.py` & `pyqodeng-0.0.8/setup.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/helpers.py` & `pyqodeng-0.0.8/test/helpers.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/server.py` & `pyqodeng-0.0.8/test/server.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_api/test_code_edit.py` & `pyqodeng-0.0.8/test/test_api/test_code_edit.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_api/test_decoration.py` & `pyqodeng-0.0.8/test/test_api/test_decoration.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_api/test_extension.py` & `pyqodeng-0.0.8/test/test_api/test_extension.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_api/test_folding.py` & `pyqodeng-0.0.8/test/test_api/test_folding.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_api/test_text.py` & `pyqodeng-0.0.8/test/test_api/test_text.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_api/test_utils.py` & `pyqodeng-0.0.8/test/test_api/test_utils.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_backend/test_workers.py` & `pyqodeng-0.0.8/test/test_backend/test_workers.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_cache.py` & `pyqodeng-0.0.8/test/test_cache.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_managers/test_backend.py` & `pyqodeng-0.0.8/test/test_managers/test_backend.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_managers/test_file_manager.py` & `pyqodeng-0.0.8/test/test_managers/test_file_manager.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_modes/test_autocomplete.py` & `pyqodeng-0.0.8/test/test_modes/test_autocomplete.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_modes/test_autoindent.py` & `pyqodeng-0.0.8/test/test_modes/test_autoindent.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_modes/test_backspace.py` & `pyqodeng-0.0.8/test/test_modes/test_backspace.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_modes/test_caret_line_highlight.py` & `pyqodeng-0.0.8/test/test_modes/test_caret_line_highlight.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_modes/test_checker.py` & `pyqodeng-0.0.8/test/test_modes/test_checker.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_modes/test_code_completion.py` & `pyqodeng-0.0.8/test/test_modes/test_code_completion.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_modes/test_extended_selection.py` & `pyqodeng-0.0.8/test/test_modes/test_extended_selection.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_modes/test_filewatcher.py` & `pyqodeng-0.0.8/test/test_modes/test_filewatcher.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_modes/test_indenter.py` & `pyqodeng-0.0.8/test/test_modes/test_indenter.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_modes/test_matcher.py` & `pyqodeng-0.0.8/test/test_modes/test_matcher.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_modes/test_occurrences.py` & `pyqodeng-0.0.8/test/test_modes/test_occurrences.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_modes/test_pygments_highlighter.py` & `pyqodeng-0.0.8/test/test_modes/test_pygments_highlighter.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_modes/test_right_margin.py` & `pyqodeng-0.0.8/test/test_modes/test_right_margin.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_modes/test_word_click.py` & `pyqodeng-0.0.8/test/test_modes/test_word_click.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_modes/test_zoom.py` & `pyqodeng-0.0.8/test/test_modes/test_zoom.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_panels/test_checker.py` & `pyqodeng-0.0.8/test/test_panels/test_checker.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_panels/test_encoding.py` & `pyqodeng-0.0.8/test/test_panels/test_encoding.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_panels/test_folding.py` & `pyqodeng-0.0.8/test/test_panels/test_folding.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_panels/test_line_nbr.py` & `pyqodeng-0.0.8/test/test_panels/test_line_nbr.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_panels/test_marker.py` & `pyqodeng-0.0.8/test/test_panels/test_marker.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_panels/test_search_and_replace.py` & `pyqodeng-0.0.8/test/test_panels/test_search_and_replace.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_widgets/parsed_output.txt` & `pyqodeng-0.0.8/test/test_widgets/parsed_output.txt`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_widgets/raw_output.txt` & `pyqodeng-0.0.8/test/test_widgets/raw_output.txt`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_widgets/test_output_window.py` & `pyqodeng-0.0.8/test/test_widgets/test_output_window.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_widgets/test_recent_files.py` & `pyqodeng-0.0.8/test/test_widgets/test_recent_files.py`

 * *Files identical despite different names*

### Comparing `pyqodeng-0.0.7/test/test_widgets/test_splittable_tab_widget.py` & `pyqodeng-0.0.8/test/test_widgets/test_splittable_tab_widget.py`
