# Comparing `tmp/pywxdll-0.1.tar.gz` & `tmp/pywxdll-0.1.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist/pywxdll-0.1.tar", last modified: Mon May  1 17:38:01 2023, max compression
+gzip compressed data, was "dist/pywxdll-0.1.1.tar", last modified: Mon May  1 18:03:21 2023, max compression
```

## Comparing `pywxdll-0.1.tar` & `pywxdll-0.1.1.tar`

### file list

```diff
@@ -1,13 +1,14 @@
-drwxr-xr-x   0 henryyang   (501) staff       (20)        0 2023-05-01 17:38:01.000000 pywxdll-0.1/
--rw-r--r--   0 henryyang   (501) staff       (20)     1067 2023-04-30 06:33:02.000000 pywxdll-0.1/LICENSE
--rw-rw-r--   0 henryyang   (501) staff       (20)       26 2023-05-01 17:30:43.000000 pywxdll-0.1/MANIFEST.in
--rw-r--r--   0 henryyang   (501) staff       (20)      697 2023-05-01 17:38:01.000000 pywxdll-0.1/PKG-INFO
--rw-r--r--   0 henryyang   (501) staff       (20)      471 2023-05-01 16:22:12.000000 pywxdll-0.1/README.md
-drwxr-xr-x   0 henryyang   (501) staff       (20)        0 2023-05-01 17:38:01.000000 pywxdll-0.1/pywxdll.egg-info/
--rw-r--r--   0 henryyang   (501) staff       (20)      697 2023-05-01 17:38:01.000000 pywxdll-0.1/pywxdll.egg-info/PKG-INFO
--rw-r--r--   0 henryyang   (501) staff       (20)      192 2023-05-01 17:38:01.000000 pywxdll-0.1/pywxdll.egg-info/SOURCES.txt
--rw-r--r--   0 henryyang   (501) staff       (20)        1 2023-05-01 17:38:01.000000 pywxdll-0.1/pywxdll.egg-info/dependency_links.txt
--rw-r--r--   0 henryyang   (501) staff       (20)       17 2023-05-01 17:38:01.000000 pywxdll-0.1/pywxdll.egg-info/requires.txt
--rw-r--r--   0 henryyang   (501) staff       (20)        1 2023-05-01 17:38:01.000000 pywxdll-0.1/pywxdll.egg-info/top_level.txt
--rw-r--r--   0 henryyang   (501) staff       (20)       38 2023-05-01 17:38:01.000000 pywxdll-0.1/setup.cfg
--rw-r--r--   0 henryyang   (501) staff       (20)     3778 2023-05-01 17:37:55.000000 pywxdll-0.1/setup.py
...
### Comparing `pywxdll-0.1/LICENSE` & `pywxdll-0.1.1/LICENSE`

 * *Files identical despite different names*

### Comparing `pywxdll-0.1/PKG-INFO` & `pywxdll-0.1.1/PKG-INFO`
...
### Comparing `pywxdll-0.1/pywxdll.egg-info/PKG-INFO` & `pywxdll-0.1.1/pywxdll.egg-info/PKG-INFO`
...
### Comparing `pywxdll-0.1/setup.py` & `pywxdll-0.1.1/setup.py`
