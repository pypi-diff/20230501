# Comparing `tmp/trytond_account_rule-6.6.0.tar.gz` & `tmp/trytond_account_rule-6.8.0.tar.gz`
...
### Comparing `trytond_account_rule-6.6.0/locale/de.po` & `trytond_account_rule-6.8.0/locale/de.po`
