# Comparing `tmp/trytond_sale_price_list-6.6.0.tar.gz` & `tmp/trytond_sale_price_list-6.8.0.tar.gz`
...
### Comparing `trytond_sale_price_list-6.6.0/locale/es.po` & `trytond_sale_price_list-6.8.0/locale/es.po`
