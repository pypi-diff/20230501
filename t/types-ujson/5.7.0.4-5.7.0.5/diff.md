# Comparing `tmp/types-ujson-5.7.0.4.tar.gz` & `tmp/types-ujson-5.7.0.5.tar.gz`
...
## Comparing `types-ujson-5.7.0.4.tar` & `types-ujson-5.7.0.5.tar`
...
### Comparing `types-ujson-5.7.0.4/CHANGELOG.md` & `types-ujson-5.7.0.5/CHANGELOG.md`
...
### Comparing `types-ujson-5.7.0.4/PKG-INFO` & `types-ujson-5.7.0.5/PKG-INFO`
...
### Comparing `types-ujson-5.7.0.4/setup.py` & `types-ujson-5.7.0.5/setup.py`
...
### Comparing `types-ujson-5.7.0.4/types_ujson.egg-info/PKG-INFO` & `types-ujson-5.7.0.5/types_ujson.egg-info/PKG-INFO`
