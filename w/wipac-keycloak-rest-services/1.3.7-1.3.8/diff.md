# Comparing `tmp/wipac-keycloak-rest-services-1.3.7.tar.gz` & `tmp/wipac-keycloak-rest-services-1.3.8.tar.gz`
...
### Comparing `wipac-keycloak-rest-services-1.3.7/LICENSE` & `wipac-keycloak-rest-services-1.3.8/LICENSE`
