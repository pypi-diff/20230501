# Comparing `tmp/xia_engine_terraform-0.1.6-cp39-none-win_amd64.whl.zip` & `tmp/xia_engine_terraform-0.1.7-cp39-none-win_amd64.whl.zip`

## zipinfo {}

```diff
@@ -1,9 +1,9 @@
-Zip file size: 221554 bytes, number of entries: 7
--rw-r--r--  2.0 unx      645 b- defN 23-May-01 11:23 xia_engine_terraform/__init__.py
--rw-r--r--  2.0 unx   596992 b- defN 23-May-01 11:26 xia_engine_terraform/engine.cp39-win_amd64.pyd
--rw-rw-rw-  2.0 unx      152 b- defN 23-May-01 11:26 xia_engine_terraform-0.1.6.dist-info/LICENSE.txt
--rw-r--r--  2.0 unx      724 b- defN 23-May-01 11:26 xia_engine_terraform-0.1.6.dist-info/METADATA
--rw-r--r--  2.0 unx       99 b- defN 23-May-01 11:26 xia_engine_terraform-0.1.6.dist-info/WHEEL
--rw-r--r--  2.0 unx       21 b- defN 23-May-01 11:26 xia_engine_terraform-0.1.6.dist-info/top_level.txt
-?rw-rw-r--  2.0 unx      646 b- defN 23-May-01 11:26 xia_engine_terraform-0.1.6.dist-info/RECORD
-7 files, 599279 bytes uncompressed, 220388 bytes compressed:  63.2%
...
## Comparing `xia_engine_terraform-0.1.6.dist-info/METADATA` & `xia_engine_terraform-0.1.7.dist-info/METADATA`
